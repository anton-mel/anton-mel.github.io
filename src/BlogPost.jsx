  ...
  const blogPosts = {
    'ooo-parcv2': {
      ...
      content: [
        ...
        { type: 'image', src: '/figure1.png', alt: 'Figure 1: Demonstration of src0_byp_mux_sel = 0b100, indicating bypassing from ROB', caption: 'Figure 1: Demonstration of src0_byp_mux_sel = 0b100, indicating bypassing from ROB' },
        ...
        { type: 'image', src: '/figure2.png', alt: 'Figure 2: An updated pipeline which adds the ROB after the writeback stage and separates writeback from the commit logic', caption: 'Figure 2: An updated pipeline which adds the ROB after the writeback stage and separates writeback from the commit logic' },
    ...
    'perceptron-branch-prediction': {
      ...
      content: [
        ...
        { type: 'image', src: '/charts.png', alt: 'Perceptron vs. gshare summary charts', caption: 'Summary charts illustrating misprediction rate vs. budget and history length.' }
      ]
    },
  };
